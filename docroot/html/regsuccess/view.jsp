   ...
   <div class="container-shadow">
    ...
    <fieldset class="clearfix ">
        <div class="group-field-block">
            <label for="userOrEmployeeId" class="align-left">Registration successful</label>
            <label>To login..<a href="http://localhost:8080/web/touroone/tourohome">CLICK HERE</a></label> 
			<meta content="5; url=http://localhost:8080/web/touroone/tourohome" http-equiv="refresh" />
