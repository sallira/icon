...
<body>
   ...
   <div class="container-shadow">
      <h1 class="float-left">Forgotten Password?</h1>
      <fieldset class="fieldsetWithOutBorder ">
      </fieldset>
     <form action="${testParameterUrl}" name="forgottenLoginID" class="form clearfix"  method="post" autocomplete="off">
    <!-- hidden field used to help with password validation -->
    <input type="hidden" name="_id">

    <fieldset class="clearfix ">
        <div class="group-field-block">
            <label for="userOrEmployeeId" class="align-left">Your Username</label> 
