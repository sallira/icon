...
<body>
   ...
   <div class="container-shadow">
      <h1 class="float-left">Forgotten Username?</h1>
      <fieldset class="fieldsetWithOutBorder ">
          <p>Please enter your ID in the field below to get your Username.</p>
      </fieldset>
     <form action="${testParameterUrl}"  class="form clearfix"  method="POST" autocomplete="off">
    <!-- hidden field used to help with password validation -->
    <input type="hidden" name="_id">

    <fieldset class="clearfix ">
        <div class="group-field-block">
            <label for="userOrEmployeeId" class="align-left">TouroOne / Student / Employee ID</label> 
